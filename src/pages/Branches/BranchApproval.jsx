    ...
    <div className="branch-approval-container">
      ...
      <div className="partners-page-header">
        ...
        <div className="partners-header-buttons">
          ...
          <button className="primary-action-btn font-bold" type="button" style={{ cursor: 'pointer',  height: '36px' }} onClick={() => addToast('Action performed successfully.', 'success')}>
...
<table className="partner-table">
        ...
        <div className="directory-table-footer" style={{ marginTop: '16px' }}>
          ...
          <div className="pagination-wrap">
            ...
            <button className="pag-num-btn" type="button" style={{ cursor: 'pointer' }} onClick={() => addToast('Action performed successfully.', 'success')}>5</button>
